                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={7}>
                                <Paper style={{ height: "20rem", position: "relative" }}>
                                    ...
                                    <FlexibleXYPlot style={{ position: "relative", marginBottom: "2rem" }} >
                                        <VerticalGridLines />
                                        <HorizontalGridLines />
                                        <XAxis
                                            tickLabelAngle={-90}
                                    ...
                                    >
                                        <Button
                                            ...
                                            onClick={() => { this.changeChartView("last day") }}
                                        >
                                            Today
                                        </Button>
                                        <Button
                                            ...
                                            onClick={() => { this.changeChartView("last month") }}
                                        >
                                            Month
                    </Button>
                                        <Button
                                            ...
                                            onClick={() => { this.changeChartView("last year") }}
                                        >
                                            Year
                    </Button>
                                    </div>
